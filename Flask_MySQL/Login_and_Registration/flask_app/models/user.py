...
class User:
    ...
    def validate_user(data):
        ...
        if len(data["first_name"]) < 2 or not data["first_name"].isalpha():
            flash("First name must be at least 2 characters and consist of only letters.", "register")
            is_valid = False
        
        if len(data["last_name"]) < 2 or not data["last_name"].isalpha():
            flash("Last name must be at least 2 characters and consist of only letters.", "register")
            is_valid = False
